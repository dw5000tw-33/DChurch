...
(function(){
  ...
  style.textContent = `
    ...
    #line-fab .card{background:${THEME.white};border-radius:20px;box-shadow:0 10px 26px rgba(0,0,0,.14);padding:10px;border:4px solid ${THEME.blue};min-width: 260px;touch-action:none}
    #line-fab .row{display:flex;gap:8px;flex-wrap:wrap}
    #line-fab button{border:0;border-radius:12px;padding:10px 20px;cursor:pointer;font-weight:700;flex:1 1 auto;min-width:96px;min-height:44px}
